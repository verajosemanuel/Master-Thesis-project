...
# Dado que las palabras difieren según el departamento, se colocan fuera y
# de momento solo existen dos opciones para el parámetro: financiero y legal
...
source resumen_financiero.sh
else
source resumen_juridico.sh
fi
